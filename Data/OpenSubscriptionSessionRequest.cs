namespace IsbmClient
{
    ...
    public partial class OpenSubscriptionSessionRequest
    {
        ...
        public OpenSubscriptionSessionRequest(string ChannelURI, System.Collections.Generic.List<string> Topic, string ListenerURL, string XPathExpression, System.Collections.Generic.List<Namespace> XPathNamespace)
        {
