namespace IsbmClient
{
    ...
    [System.ServiceModel.MessageContractAttribute(WrapperName="OpenSubscriptionSession", WrapperNamespace="http://www.openoandm.org/xml/ISBM/", IsWrapped=true)]
    public partial class OpenSubscriptionSessionRequest
    {
        ...
        public OpenSubscriptionSessionRequest(string ChannelURI, System.Collections.Generic.List<string> Topic, string ListenerURI, string XPathExpression, System.Collections.Generic.List<Namespace> XPathNamespace)
        {
